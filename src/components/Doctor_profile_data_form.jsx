...
const Doctor_profile_data_form = () => {
  ...
  const validateForm = () => {
    ...
    if (!formData.available_time.trim()) errors.available_time = 'Available time is required.';
      ...
      <form onSubmit={handleSubmit} className="space-y-4" encType="multipart/form-data">
        ...
        <div>
          <input
            ...
            className="w-full p-2 border rounded"
          />
          {formErrors.profession && <p className="text-red-600 text-sm">{formErrors.profession}</p>}
        </div>
        ...
        <div>
          <input
            ...
            className="w-full p-2 border rounded"
          />
          {formErrors.experience && <p className="text-red-600 text-sm">{formErrors.experience}</p>}
        </div>
        ...
        <div>
          <input
            ...
            className="w-full p-2 border rounded"
          />
          {formErrors.available_time && <p className="text-red-600 text-sm">{formErrors.available_time}</p>}
        </div>
        ...
        <div>
          <input
            ...
            className="w-full p-2 border rounded"
          />
          {formErrors.fees && <p className="text-red-600 text-sm">{formErrors.fees}</p>}
        </div>
        ...
        <div>
          ...
          {formErrors.imageFile && <p className="text-red-600 text-sm mt-1">{formErrors.imageFile}</p>}
        </div>
